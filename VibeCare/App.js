...
<Stack.Screen name="FeedbackScreen" component={FeedbackScreen} options={{ headerShown: false }} />
 ...
 <Stack.Screen name="SuccessStoriesScreen" component={SuccessStoriesScreen} options={{headerShownfalse}}/>
 <Stack.Screen name="AdminSuccessStories" component={AdminSuccessStoriesScreen} options={{headerShownfalse}}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
}
