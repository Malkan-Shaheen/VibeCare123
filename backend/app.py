...
def load_suggestion_models():
    ...
    try:
        ...
        suggestion_model = joblib.load(r'D:\ReactNative-Final\ReactNative\backend\model_suggest.joblib')
        label_encoder = joblib.load(r'D:\ReactNative-Final\ReactNative\backend\label_encoder_suggest.joblib')
...
def load_stress_model():
    ...
    try:
        stress_model = tf_load_model(r'D:\ReactNative-Final\ReactNative\backend\stress_model.h5')
        stress_scaler = joblib.load(r'D:\ReactNative-Final\ReactNative\backend\scaler3.pkl')
...
def load_suggestion_model_v2():
    ...
    try:
        suggestion_model_v2 = joblib.load(r"D:\ReactNative-Final\ReactNative\backend\suggestion_model.pkl")
        print("✅ Suggestion model loaded.")
    except Exception as e:
        print("❌ Error loading suggestion model:", e)

    try:
        suggestion_label_encoder = joblib.load(r"D:\ReactNative-Final\ReactNative\backend\depression_scaler.pkl")
...
def load_depression_model():
    ...
    try:
        depression_model = tf_load_model(r"D:\ReactNative-Final\ReactNative\backend\depression_model.h5", compile=False)
...
def load_anxiety_model():
    ...
    try:
        anxiety_model = joblib.load(r"D:\ReactNative-Final\ReactNative\backend\anxiety_model.pkl")
